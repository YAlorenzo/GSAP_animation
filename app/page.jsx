      ...
      <div className="mb-32 text-center lg:max-w-5xl  flex gap-5  mx-auto justify-center mt-10 lg:w-full lg:mb-0 lg:text-left">
        {animationShowList.map((elem) => (
           <Link
            href={elem.link}
            id={elem.id}
            className="group rounded-lg border border-transparent px-5 py-4 h-max transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
        >
